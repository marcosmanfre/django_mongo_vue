...
<tbody>
    <tr v-for="jov in jovens">
        <td>{{jov.jovem_id}}</td>
        <td>{{jov.registro}}</td>
        <td>{{jov.nome}}</td>
        <td>{{jov.secao}}</td>
        <td>{{jov.promessa}}</td>
        <td>{{jov.data_nascimento}}</td>
        <td>{{jov.valor_mensalidade}}</td>
        <td>
            <button type="button"
            ...
            <button type="button" @click="deleteClick(jov.jovem_id)"
            class="btn btn-light mr-1">
    ...
    <div class="d-flex flex-row bd-highlight mb-3">
        <div class="p-2 w-50 bd-highlight">
            ...
            <div class="input-group mb-3">
                ...
                <select class="form-select" v-model="secao_nome">
                    <option v-for="dep in secao">
                    {{jov.nome}}
                    </option>
                </select>
            </div>
